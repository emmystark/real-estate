...
(function($e, ye) {
    typeof exports == "object" && typeof module < "u" ? module.exports = ye() : typeof define == "function" && define.amd ? define("uikit", ye) : ($e = typeof globalThis < "u" ? globalThis : $e || self, $e.bdtUIkit = ye())
})(this, function() {
    "use strict";
    const {
        hasOwnProperty: $e,
    ...
    const nr = /\B([A-Z])/g,
        Dt = ht(t => t.replace(nr, "-$1").toLowerCase()),
        or = /-(\w)/g,
        ke = ht(t => (t.charAt(0).toLowerCase() + t.slice(1)).replace(or, (e, i) => i.toUpperCase())),
    ...
    function Te(t, e) {
        return t === e || St(t) && St(e) && Object.keys(t).length === Object.keys(e).length && se(t, (i, s) => i === e[s])
    }
    ...
    function nt(t, e, i = 0, s = !1) {
        ...
        return n ? (t = mt(t) ? xt(t) : t === "next" ? i + 1 : t === "previous" ? i - 1 : t === "last" ? n - 1 : e.indexOf(W(t)), s ? Q(t, 0, n - 1) : (t %= n, t < 0 ? t + n : t)) : -1
    }
    ...
    function g(t, e, i) {
        ...
        for (const n of T(t)) tt(i) && (i = i.call(n, g(n, e))), i === null ? Ce(n, e) : n.setAttribute(e, i)
    }
    ...
    function Yi(t) {
        if (ae(t)) {
            const {
                hash: e,
                ownerDocument: i
            } = W(t), s = decodeURIComponent(e).slice(1);
    ...
    function Us(t, e = document) {
        return N(t) && Vs(t).isContextSelector || Se(e) ? e : e.ownerDocument
    }
    const hr = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g,
        cr = /.*?[^\\](?![^(]*\))(?:,|$)/g,
        ur = /\s*,$/,
        Vs = ht(t => {
            ...
            let i = !1;
            const s = [];
            for (let n of (e = t.match(cr)) != null ? e : []) n = n.replace(ur, "").trim(), i || (i = ["!", "+", "~", "-", ">"].includes(n[0])), s.push(n);
            return {
                selector: s.join(","),
                selectors: s,
                isContextSelector: i
    ...
    function Gs(t, e = document, i) {
        ...
        for (let o of s.selectors) {
            let r, a = e;
            if (o[0] === "!" && ([r, o] = Ys(o), a = e.parentElement.closest(r), !o && n) || a && o[0] === "-" && ([r, o] = Ys(o), a = a.previousElementSibling, a = C(a, r) ? a : null, !o && n)) return a;
            if (a) {
                if (n) return o[0] === "~" || o[0] === "+" ? (o = `:scope > :nth-child(${$t(a)+1}) ${o}`, a = a.parentElement) : o[0] === ">" && (o = `:scope ${o}`), Xi(a, i, o);
                t += `${t?",":""}${fr(a)} ${o}`
            }
        }
        return Se(e) || (e = e.ownerDocument), Xi(e, i, t)
    }
    ...
    function F(...t) {
        const [e, i, s, n, o = !1, r] = Ki(t), a = $(e, i, s, l => {
            const c = !r || r(l);
            c && (a(), n(l, c))
        }, o);
        return a
    ...
    function b(t, e, i) {
        return Qi(t).every(s => s.dispatchEvent(he(e, !0, !0, i)))
    }
    ...
    function Ki(t) {
        return t[0] = Qi(t[0]), N(t[1]) && (t[1] = t[1].split(" ")), tt(t[2]) && t.splice(2, 0, !1), t
    }
    ...
    function Qi(t) {
        return G(t) ? t.map(mr).filter(Boolean) : N(t) ? le(t) : Xs(t) ? [t] : T(t)
    }
    ...
    function h(t, e, i, s) {
        ...
        for (const o of n)
            if (N(e)) {
                ...
                o.style.setProperty(e, mt(i) && !vr[e] ? `${i}px` : i || Ee(i) ? i : "", s)
            } else if (G(e)) {
            const r = {};
    ...
    function Ks(t, e, i = 200, s, n) {
        return Promise.all(T(t).map(o => new Promise((r, a) => {
            x(o, Me) && b(o, hi);
            const l = [e, Me, `${Me}-${n?"leave":"enter"}`, s && `bdt-transform-origin-${s}`, n && `${Me}-reverse`],
                c = setTimeout(() => b(o, Js), i);
            F(o, [Js, hi], ({
                type: u
            }) => {
                clearTimeout(c), u === hi ? a() : r(o), h(o, "animationDuration", ""), _(o, l)
            }, {
                self: !0
            }), h(o, "animationDuration", `${i}ms`), S(o, l)
        })))
    }
    const Ct = { in: Ks,
        out(t, e, i, s) {
    ...
    function _t(t, e) {
        if (Ie(t))
            for (e(t), t = t.firstElementChild; t;) _t(t, e), t = t.nextElementSibling
    }
    ...
    function m(t) {
        const e = Ie(t) ? W(t).getBoundingClientRect() : {
            height: et(t),
            width: pi(t),
            top: 0,
            left: 0
    ...
    function Ne(t) {
        ...
        for (; t = t.offsetParent;)
            if (e[0] += t.offsetTop + k(h(t, "borderTopWidth")), e[1] += t.offsetLeft + k(h(t, "borderLeftWidth")), h(t, "position") === "fixed") {
                const i = Mt(t);
    ...
    function en(t) {
        ...
        return (i, s) => {
            if (X(s)) {
                ...
                return i = W(i), s = h(i, t), s = s === "auto" ? i[`offset${e}`] : k(s) || 0, s - ce(i, t)
    ...
    function Tr() {
        return ze || (ue || (ue = y("<div>"), h(ue, {
            height: "100vh",
            position: "fixed"
        }), $(window, "resize", () => ze = null)), q(document.body, ue), ze = ue.clientHeight, ot(ue), ze)
    }
    const At = {
            read: Cr,
            write: Pr,
    ...
    class rn {
        init() {
            this.positions = [];
            let e;
            this.unbind = $(document, "mousemove", i => e = yt(i)), this.interval = setInterval(() => {
    ...
    function pn(t, {
        ...
        return i.reduce((r, a, l) => {
            const {
                ...
                scrollHeight: u,
                offsetHeight: f
            } = a, d = rt(a), p = u - d.height, {
                height: w,
                top: I
            } = i[l - 1] ? rt(i[l - 1]) : E(t);
            let P = Math.ceil(I - d.top - e + c);
            return e > 0 && f < w + e ? P += e : e = 0, P > p ? (e -= P - p, P = p) : P < 0 && (e -= P, P = 0), () => s(a, P - c, t, p).then(r)
        }, () => Promise.resolve())();
        ...
        function s(r, a, l, c) {
            return new Promise(u => {
                ...
                (function we() {
                    ...
                    let bt = 0;
                    i[0] === r && f + a < c && (bt = E(l).top + (w ? 0 : r.scrollTop) - I - m(us(l)).height), r.scrollTop = f + (a + bt) * xe, xe === 1 && (P === bt || !vt--) ? u() : (P = bt, requestAnimationFrame(we))
                })()
            })
        }
    ...
    function jt(t, e = !1, i = []) {
        ...
        return ~o && (n = n.slice(o)), [s].concat(n.filter(r => h(r, "overflow").split(" ").some(a => v(["auto", "scroll", ...i], a)) && (!e || r.scrollHeight > rt(r).height))).reverse()
    }
    ...
    function rt(t) {
        ...
        for (let [n, o, r, a] of [
            ...
            const l = s[n] % 1;
            s[n] = s[o] = i[`client${kt(n)}`] - (l ? l < .5 ? -l : 1 - l : 0), s[a] = s[n] + s[r]
        }
        return s
    }
    ...
    function us(t) {
        ...
        for (const n of s ? [0, s] : [0]) {
            let o;
            for (const r of Mt(t).document.elementsFromPoint(e + i / 2, n)) !r.contains(t) && !x(r, "bdt-togglable-leave") && (fs(r, "fixed") && gn(Oe(t).reverse().find(a => !a.contains(r) && !fs(a, "static"))) < gn(r) || fs(r, "sticky") && D(r).contains(t)) && (!o || m(o).height < m(r).height) && (o = r);
            if (o) return o
        }
    }
    ...
    function zr(t, e, i, s) {
        const [n, o, r, a] = at[s], [l] = xn(t, e), c = rt(l);
        return ["auto", "scroll"].includes(h(l, `overflow-${o}`)) && (c[r] -= l[`scroll${kt(r)}`], c[a] = c[r] + l[`scroll${kt(n)}`]), c[r] += i, c[a] -= i, c
    }
    ...
    var Rr = {
        ...
        methods: {
            start() {
                this.stop(), this.update(), this.timer || (b(this.$el, "countdownstart"), this.timer = setInterval(this.update, 1e3))
            },
            stop() {
            ...
            update() {
                ...
                for (const e of jr) {
                    ...
                    i.textContent !== s && (s = s.split(""), s.length !== i.children.length && Pt(i, s.map(() => "<span></span>").join("")), s.forEach((n, o) => i.children[o].textContent = n))
                }
            }
        }
    };
    ...
    const V = {};
    V.events = V.watch = V.observe = V.created = V.beforeConnect = V.connected = V.beforeDisconnect = V.disconnected = V.destroy = gs, V.args = function(t, e) {
        return e !== !1 && gs(e || t)
    ...
    function He(t, e, i) {
        const s = {};
        if (tt(e) && (e = e.options), e.extends && (t = He(t, e.extends, i)), e.mixins)
    ...
    function ms(t, e) {
        return t === Boolean ? Wi(e) : t === Number ? xt(e) : t === "list" ? Yr(e) : t === Object && N(e) ? fe(e) : t ? t(e) : e
    }
    const Vr = /,(?![^(]*\))/;

    function Yr(t) {
        return G(t) ? t : N(t) ? t.split(Vr).map(e => mt(e) ? xt(e) : Wi(e.trim())) : [t]
    }
    ...
    function Le(t, e = "update") {
        t._connected && t._updates.length && (t._queued || (t._queued = new Set, At.read(() => {
    ...
    function Kr(t, e) {
        for (const {
            ...
            let o;
            i && (o = i.call(t, t._data, e), o && te(o) && ft(t._data, o)), s && o !== !1 && At.write(() => {
    ...
    function Si(t = {}) {
        return de({
            handler: function(e, i) {
                ...
                for (const o of T(tt(s) ? s(this) : s)) z('[loading="lazy"]', o).slice(0, n - 1).forEach(r => Ce(r, "loading"));
    ...
    async function ta(t, e, i) {
        ...
        const n = s.map(p => Tn(p, !0)),
            ...
            r = s.concat(e);
        await Promise.all(r.map(B.cancel)), h(r, "transitionProperty", "none"), await t(), s = s.concat(M(e).filter(p => !v(s, p))), await Promise.resolve(), h(r, "transitionProperty", "");
        const a = g(e, "style"),
        ...
        try {
            await Promise.all(d), s.forEach((p, w) => {
    ...
    function Pn(t, e, i, s = 0) {
        const n = Ii(e, !0),
            ...
            l = a(async () => {
                S(e, $s), await Promise.all(An(e).map((u, f) => new Promise(d => setTimeout(() => B.start(u, r, i / 2, "ease").then(d), f * s)))), _(e, $s)
            }),
            c = a(async () => {
                const u = et(e);
                S(e, ys), t(), h(M(e), {
                ...
                u !== d && w.push(B.start(e, {
                    height: d
                }, i / 2 + p.length * s, "ease")), await Promise.all(w).then(() => {
                    _(e, ys), n === Ii(e) && (h(e, {
                        height: "",
                        alignContent: ""
                    }), h(f, {
    ...
    var On = {
        ...
        methods: {
            animate(t, e = this.$el) {
                ...
                return (i === "fade" ? Pn : i === "delayed-fade" ? (...n) => Pn(...n, 40) : i ? ta : () => (t(), Promise.resolve()))(t, e, this.duration).catch(A)
            }
        }
    };
    const O = {
    ...
    var na = {
        ...
        events: {
            ...
            handler(t) {
                t.type === "keydown" && t.keyCode !== O.SPACE || t.target.closest("a,button") && (t.preventDefault(), this.apply(t.current))
            }
        },
        methods: {
            apply(t) {
    ...
    function Mn(t, e, i) {
        ...
        return (s || X(o)) && (n ? s ? (delete i.filter[""], i.filter[n] = s) : (delete i.filter[n], (ti(i.filter) || "" in i.filter) && (i.filter = {
            "": s || ""
        })) : i.filter = {
            "": s || ""
        }), X(o) || (i.sort = [o, r]), i
    ...
    var Re = {
        ...
        qt = {
            ...
            methods: {
                async toggleElement(t, e, i) {
                    try {
                        return await Promise.all(T(t).map(s => {
                            ...
                            const o = (tt(i) ? i : i === !1 || !this.hasAnimation ? ca : this.hasTransition ? ua : fa)(s, n, this),
                ...
                isToggled(t = this.$el) {
                    return t = W(t), x(t, this.clsEnter) ? !0 : x(t, this.clsLeave) ? !1 : this.cls ? x(t, this.cls.split(" ")[0]) : R(t)
                },
                _toggle(t, e) {
                    if (!t) return;
                    e = !!e;
                    let i;
                    this.cls ? (i = v(this.cls, " ") || e !== x(t, this.cls), i && j(t, this.cls, v(this.cls, " ") ? void 0 : e)) : (i = e === t.hidden, i && (t.hidden = !e)), z("[autofocus]", t).some(s => R(s) ? s.focus() || !0 : s.blur()), i && b(t, "toggled", [e, this])
                }
            }
        };
    ...
    async function ua(t, e, {
        ...
        const [l = "reveal", c = "top"] = ((a = i[0]) == null ? void 0 : a.split("-")) || [], u = [
            ["left", "right"],
            ["top", "bottom"]
        ], f = u[v(u[0], c) ? 0 : 1], d = f[1] === c, w = ["width", "height"][u.indexOf(f)], I = `margin-${f[0]}`, P = `margin-${c}`;
        let vt = m(t)[w];
        const we = B.inProgress(t);
        await B.cancel(t), e && r(t, !0);
        const xe = Object.fromEntries(["padding", "border", "width", "height", "minWidth", "minHeight", "overflowY", "overflowX", I, P].map(sr => [sr, t.style[sr]])),
            bt = m(t),
            Ws = k(h(t, I)),
            tr = k(h(t, P)),
            Kt = bt[w] + tr;
        ...
        d && (h(t, I, Kt - vt + Ws), ir[I] = e ? Ws : Kt + Ws), !d ^ l === "reveal" && (h(Hi, I, -Kt + vt), B.start(Hi, {
            [I]: e ? 0 : -Kt
        }, s, o));
        try {
            await B.start(t, ir, s, o)
        } finally {
            h(t, xe), Be(Hi.firstChild), e || r(t, !1)
        }
    }
    ...
    var Ss = {
        ...
        events: [{
            ...
            handler(t) {
                ...
                !i && s && ae(e) && !this.$el.contains(y(s)) ? this.hide() : C(e, this.selClose) && (t.preventDefault(), this.hide())
            }
        }, {
            name: "toggle",
            self: !0,
            ...
            self: !0,
            handler() {
                v(st, this) && st.splice(st.indexOf(this), 1), h(this.$el, "zIndex", ""), st.some(t => t.clsPage === this.clsPage) || _(document.documentElement, this.clsPage)
            }
        }],
        methods: {
            toggle() {
            ...
            show() {
                return this.container && D(this.$el) !== this.container ? (q(this.container, this.$el), new Promise(t => requestAnimationFrame(() => this.show().then(t)))) : this.toggleElement(this.$el, !0, Nn)
            },
            hide() {
    ...
    function ga(t) {
        return $(document, ct, ({
            ...
            Bt(st) !== t || t.overlay && !t.$el.contains(e) || t.panel.contains(e) || F(document, `${Et} ${oi} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
    ...
    function va(t, e, i, {
        ...
        return {
            ...
            show(f, d = 0, p) {
                const w = p ? "linear" : n;
                return f -= Math.round(f * Q(d, -1, 1)), this.translate(d), Ut(e, "itemin", {
                    percent: d,
                    duration: f,
                    timing: w,
                    dir: i
            ...
            translate(f) {
                this.reset();
                const d = r(f, i);
                h(e, d[1]), h(t, d[0]), Ut(e, "itemtranslatein", {
                    percent: f,
                    dir: i
    ...
    var xa = {
        ...
        events: [{
            ...
            handler(t) {
                !this.draggable || this.parallax || !dt(t) && $a(t.target) || t.target.closest(Pe) || t.button > 0 || this.length < 2 || this.start(t)
            }
        }, {
            name: "dragstart",
            handler(t) {
        ...
        methods: {
            start() {
                this.drag = this.pos, this._transitioner ? (this.percent = this._transitioner.percent(), this.drag += this._transitioner.getDistance() * this.percent * this.dir, this._transitioner.cancel(), this._transitioner.translate(this.percent), this.dragging = !0, this.stack = []) : this.prevIndex = this.index, $(document, Es, this.move, Ue), $(document, Hn, this.end, Fn), h(this.list, "userSelect", "none")
            },
            move(t) {
                const e = this.pos - this.drag;
                if (e === 0 || this.prevPos === this.pos || !this.dragging && Math.abs(e) < this.threshold) return;
                this.dragging || $(this.list, "click", Ln, Ue), t.cancelable && t.preventDefault(), this.dragging = !0, this.dir = e < 0 ? 1 : -1;
                let {
                    slides: i,
                    prevIndex: s
                } = this, n = Math.abs(e), o = this.getIndex(s + this.dir), r = Wn.call(this, s, o);
                for (; o !== s && n > r;) this.drag -= r * this.dir, s = o, n -= r, o = this.getIndex(s + this.dir), r = Wn.call(this, s, o);
                this.percent = n / r;
                const a = i[s],
                    l = i[o],
                    c = this.index !== o,
                    u = s === o;
                let f;
                for (const d of [this.index, this.prevIndex]) v([o, s], d) || (b(i[d], "itemhidden", [this]), u && (f = !0, this.prevIndex = s));
                (this.index === s && this.prevIndex !== s || f) && b(i[this.index], "itemshown", [this]), c && (this.prevIndex = s, this.index = o, u || (b(a, "beforeitemhide", [this]), b(a, "itemhide", [this])), b(l, "beforeitemshow", [this]), b(l, "itemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), a, !u && l)
            },
            end() {
                if (Tt(document, Es, this.move, Ue), Tt(document, Hn, this.end, Fn), this.dragging)
                ...
                setTimeout(() => Tt(this.list, "click", Ln, Ue)), h(this.list, {
                    userSelect: ""
    ...
    function ka(t, e) {
        for (const {
                ...
                handler: s,
                immediate: n = !0
            } of t._watches)(t._initial && n || pt(e, i) && !Te(e[i], t[i])) && s.call(t, t[i], e[i]);
        t._initial = !1
    }
    ...
    function Vn(t, e, i) {
        ...
        n = tt(n) ? n.call(t, t) : n || t.$el, !(!n || G(n) && !n.length || c && !c.call(t, t)) && t._events.push($(n, s, l ? N(l) ? l : l.call(t, t) : null, N(o) ? t[o] : o.bind(t), {
            passive: a,
            capture: r,
            self: u
        }))
    ...
    function Aa(t, e) {
        ...
        tt(s) && !pt(t, l) && qn(t, l, () => {
            const f = s.call(t, t);
            return G(f) ? T(f) : f
        }), n = N(n) ? t[n] : n.bind(t), tt(o) && (o = o.call(t, t));
    ...
    function Ba(t) {
        ...
        const {
            attributes: r,
            filter: a
        } = Ma(s, n), l = new MutationObserver(c => {
            const u = Gn(e);
            c.some(({
                attributeName: f
            }) => {
                const d = f.replace("data-", "");
                return (d === s ? r : [ke(d), ke(f)]).some(p => !X(u[p]) && u[p] !== i[p])
            }) && t.$reset()
        });
        l.observe(o, {
            attributes: !0,
    ...
    function Ts(t) {
        t._connected || (Da(t), ge(t, "beforeConnect"), t._connected = !0, Ta(t), Gr(t), ya(t), Pa(t), Ba(t), Ia(t), ge(t, "connected"), Le(t))
    }

    function Cs(t) {
        t._connected && (ge(t, "beforeDisconnect"), Ca(t), Jr(t), _a(t), Ea(t), ge(t, "disconnected"), t._connected = !1)
    }
    let Na = 0;

    function Xn(t, e = {}) {
        e.data = Ha(e, t.constructor.options), t.$options = He(t.constructor.options, e, t), t.$props = {}, t._uid = Na++, za(t), Fa(t), Sa(t), ge(t, "created"), e.el && t.$mount(e.el)
    }
    ...
    lt.util = Wr, lt.options = {}, lt.version = "3.21.6";
    const La = "bdt-",
        Vt = "__uikit__",
        me = {};
    ...
    function Jn(t, e) {
        ...
        return o.id = n, o.name = t, (s = o.install) == null || s.call(o, lt, o, t), lt._initialized && !o.functional && requestAnimationFrame(() => Ve(t, `[${n}],[data-${n}]`)), me[n] = o
    }
    ...
    function Ra(t) {
        t.component = Jn, t.getComponents = Ye, t.getComponent = Ti, t.update = Kn, t.use = function(i) {
            if (!i.installed) return i.call(null, this), i.installed = !0, this
        }, t.mixin = function(i, s) {
            s = (N(s) ? this.component(s) : s) || this, s.options = He(s.options, i)
        }, t.extend = function(i) {
            i || (i = {});
            const s = this,
                n = function(r) {
            ...
            return n.prototype = Object.create(s.prototype), n.prototype.constructor = n, n.options = He(s.options, i), n.super = s, n.extend = s.extend, n
        };
        let e;
    ...
    function Kn(t, e) {
        ...
        for (const i of Oe(t).reverse()) Qn(i, e);
        _t(t, i => Qn(i, e))
    }
    ...
    function qa(t) {
        t.prototype.$mount = function(e) {
            ...
            s && Cs(i), ge(i, "destroy"), ja(s, i), e && ot(i.$el)
    ...
    var Va = {
        ...
        events: [{
            ...
            handler(t) {
                t.target.closest("a,button") && (t.type === "click" || t.keyCode === O.SPACE) && (t.preventDefault(), this.show(J(t.current, this.attrItem)))
            }
        }, {
            name: "itemshow",
            handler: "updateNav"
        ...
        methods: {
            updateNav() {
                ...
                for (const e of this.navItems) {
                    ...
                    if (mt(i)) {
                        const o = xt(i) === t;
                        j(e, this.clsActive, o), j(s, "bdt-disabled", this.parallax), g(s, {
                            "aria-selected": o,
    ...
    var Zn = {
        ...
        methods: {
            show(t, e = !1) {
                ...
                if (this.dir = Xa(t, r), this.prevIndex = r, this.index = l, a && !b(a, "beforeitemhide", [this]) || !b(c, "beforeitemshow", [this, a])) {
                    this.index = this.prevIndex, o();
                    return
                }
                const u = this._show(a, c, e).then(() => {
                    a && b(a, "itemhidden", [this]), b(c, "itemshown", [this]), s.shift(), this._transitioner = null, s.length && requestAnimationFrame(() => s.length && this.show(s.shift(), !0))
                });
            ...
            _getTransitioner(t = this.prevIndex, e = this.index, i = this.dir || 1, s = this.transitionOptions) {
                return new this.Transitioner(Ee(t) ? this.slides[t] : t, Ee(e) ? this.slides[e] : e, i * (U ? -1 : 1), s)
            }
        }
    };
        ...
        so = {
            ...
            events: [{
                ...
                handler({
                    ...
                    let e = -1;
                    t === O.LEFT ? e = "previous" : t === O.RIGHT ? e = "next" : t === O.HOME ? e = 0 : t === O.END && (e = "last"), ~e && this.show(e)
                }
            }, {
                name: "beforeitemshow",
                handler(t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleElement(this.$el, !0, !1), this.animation = io.scale, _(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler() {
                ...
                async handler(t, e) {
                    ...
                    } else if (s === "iframe" || i.match(/\.(html|php)($|\?)/i)) this.setItem(e, Ge("iframe", {
                        src: i,
                        allowfullscreen: "",
                        class: "bdt-lightbox-iframe",
                        ...r
                    }));
                    else if (a = i.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)) this.setItem(e, Ge("iframe", {
            ...
            methods: {
                ...
                showControls() {
                    clearTimeout(this.controlsTimer), this.controlsTimer = setTimeout(this.hideControls, this.delayControls), S(this.$el, "bdt-active", "bdt-transition-active")
                },
                hideControls() {
    ...
    var Ci = {
        ...
        connected() {
            ...
            if (this.matchMedia = !0, t) {
                ...
                const e = () => {
                    this.matchMedia = this.mediaObj.matches, b(this.$el, he("mediachange", !1, !0, [this.mediaObj]))
                };
    ...
    function oo(t) {
        return R(t) ? Math.ceil(Math.max(0, ...z("[stroke]", t).map(e => {
            var i;
    ...
    function _i(t, e, i) {
        let s = Oi(i) || {
            ...
            n;
        return t === "x" || t === "y" ? (t = `translate${kt(t)}`, n = o => k(k(o).toFixed(s === "px" ? 0 : 6))) : t === "scale" && (s = "", n = o => {
            var r;
    ...
    function Ps(t, e, i) {
        return i.length === 1 && i.unshift(Je(e, t, "")), i = ve(i, s => el(e, s)), (s, n) => {
            const [o, r, a] = fo(i, n), l = o.map((c, u) => (c += a * (r[u] - c), u === 3 ? k(c) : parseInt(c, 10))).join(",");
            s[t] = `rgba(${l})`
        }
    }

    function el(t, e) {
        return Je(t, "color", e).split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map(k)
    }
    ...
    function il(t, e, i) {
        return i.length === 1 && i.unshift(Je(e, t, "")), i = ve(i), (s, n) => {
            s[t] = Xe(i, n)
        }
    }
    ...
    function sl(t, e, i) {
        ...
        const s = Oi(i),
            n = oo(e);
        return i = ve(i.reverse(), o => (o = k(o), s === "%" ? o * n / 100 : o)), i.some(([o]) => o) ? (h(e, "strokeDasharray", n), (o, r) => {
    ...
    function lo(t, e, i, s) {
        ...
        if (Je(e, "backgroundSize", "") === "cover") return nl(t, e, i, s);
        const r = {};
        for (const a of o) r[a] = ho(e, a);
        return co(o, r, s)
    }
    ...
    function ol(t) {
        ...
        if (Ai[e]) return Ai[e];
        const i = new Image;
        return e && (i.src = e, !i.naturalWidth && !uo[e]) ? (F(i, "error load", () => {
            Ai[e] = _s(i), b(t, he("load", !1))
        }), uo[e] = !0, _s(i)) : Ai[e] = _s(i)
    }
    ...
    function hl(t, e, i, {
        ...
        return {
            ...
            show(u, f = 0, d) {
                const p = d ? "linear" : n;
                return u -= Math.round(u * Q(f, -1, 1)), h(o, "transitionProperty", "none"), this.translate(f), h(o, "transitionProperty", ""), f = t ? f : Q(f, 0, 1), Ut(this.getItemIn(), "itemin", {
                    percent: f,
                    duration: u,
                    timing: p,
                    dir: i
            ...
            translate(u) {
                ...
                h(o, "transform", L(Q(-a + (f - f * u), -be(o), m(o).width) * (U ? -1 : 1), "px"));
                ...
                for (const I of M(o)) {
                    const P = v(d, I),
                        vt = I === p,
                        we = I === w,
                        xe = vt || !we && (P || i * (U ? -1 : 1) === -1 ^ Di(I, o) > Di(t || e));
                    Ut(I, `itemtranslate${xe?"in":"out"}`, {
                        dir: i,
                        percent: we ? 1 - u : vt ? u : P ? 1 : 0
                    })
                }
            },
            percent() {
    ...
    function Ke(t, e, i) {
        const s = Di(t, e);
        return i ? s - cl(t, e) : Math.min(s, xo(e))
    }
    ...
    var ul = {
        ...
        computed: {
            ...
            sets({
                ...
                for (let n = 0; n < this.length; n++) {
                    ...
                    e + o > s && (e = 0), this.center ? e < s / 2 && e + o + m(this.slides[nt(n + 1, this.slides)]).width / 2 > s / 2 && (i.push(n), e = s / 2 - o / 2) : e === 0 && i.push(Math.min(n, this.maxIndex)), e += o
                }
        ...
        events: {
            ...
            itemshow() {
                ~this.prevIndex && S(this._getTransitioner().getItemIn(), this.clsActive), this.updateActiveClasses(this.prevIndex)
            },
            itemshown() {
        ...
        methods: {
            ...
            updateActiveClasses(t = this.index) {
                ...
                for (const s of this.slides) {
                    ...
                    for (const o of z(_e, s)) pt(o, "_tabindex") || (o._tabindex = g(o, "tabindex")), g(o, "tabindex", n ? o._tabindex : -1)
                }
            },
            getValidIndex(t = this.index, e = this.prevIndex) {
            ...
            getIndexAt(t) {
                let e = -1;
                const i = this.center ? be(this.list) - (m(this.slides[0]).width / 2 + m(Bt(this.slides)).width / 2) : be(this.list, this.maxIndex);
                let s = t * i,
                    n = 0;
                do {
    ...
    function fl(t, e) {
        ...
        if (!e) return Math.ceil(be(t)) < Math.trunc(i + dl(t));
        const s = M(t),
            n = Math.trunc(i / 2);
        for (const o in s) {
            const r = s[o],
            ...
            if (Math.trunc(c) > Nt(s.filter(u => !l.has(u)), u => m(u).width)) return !0
        }
        return !1
    }
        ...
        ml = {
            ...
            methods: {
                init(t) {
                    ...
                    !n || s || i > 0 || ri(e) || e.closest(`.${this.clsNoDrag}`) || this.handle && !e.closest(this.handle) || (t.preventDefault(), this.pos = yt(t), this.touched = new Set([this]), this.placeholder = n, this.origin = {
                        target: e,
                        index: $t(n),
                        ...this.pos
                    }, $(document, ni, this.move), $(document, Et, this.end), this.threshold || this.start(t))
                },
                start(t) {
                    ...
                    }), S(this.drag, this.clsDrag, this.clsCustom), S(this.placeholder, this.clsPlaceholder), S(this.items, this.clsItem), S(document.documentElement, this.clsDragState), b(this.$el, "start", [this, this.placeholder]), vl(this.pos), this.move(t)
                },
                move: kl(function(t) {
                    ft(this.pos, yt(t)), !this.drag && (Math.abs(this.pos.x - this.origin.x) > this.threshold || Math.abs(this.pos.y - this.origin.y) > this.threshold) && this.start(t), this.$emit("move")
                }),
                end() {
                    if (Tt(document, ni, this.move), Tt(document, Et, this.end), !this.drag) return;
                    bl();
                    const t = this.getSortable(this.placeholder);
                    this === t ? this.origin.index !== $t(this.placeholder) && b(this.$el, "moved", [this, this.placeholder]) : (b(t.$el, "added", [t, this.placeholder]), b(this.$el, "removed", [this, this.placeholder])), b(this.$el, "stop", [this, this.placeholder]), ot(this.drag), this.drag = null;
                    for (const {
                            clsPlaceholder: e,
                            clsItem: i
                        } of this.touched)
                ...
                insert(t, e) {
                    S(this.items, this.clsItem), e && e.previousElementSibling !== t ? this.animate(() => ci(e, t)) : !e && this.target.lastElementChild !== t && this.animate(() => q(this.target, t))
                },
                remove(t) {
    ...
    function vl(t) {
        ...
        Io = setInterval(() => {
            ...
            e = Date.now(), jt(document.elementFromPoint(i, t.y)).reverse().some(o => {
                let {
                    scrollTop: r,
                    scrollHeight: a
                } = o;
    ...
    function wl(t, e) {
        ...
        return q(t, i), h(i, "margin", "0", "important"), h(i, {
            boxSizing: "border-box",
            width: e.offsetWidth,
            height: e.offsetHeight,
            padding: h(e, "padding")
    ...
    var Sl = {
        ...
        methods: {
            ...
            async hide() {
                var t;
                C(this.$el, "input:focus") || (clearTimeout(this.showTimer), this.isToggled(this.tooltip || null) && await this.toggleElement(this.tooltip, !1, !1), (t = this.reset) == null || t.call(this), ot(this.tooltip), this.tooltip = null)
            },
            async _show(t, e) {
                this.tooltip = q(this.container, `<div id="${e}" class="bdt-${this.$options.name}" role="tooltip"> <div class="bdt-${this.$options.name}-inner">${t}</div> </div>`), $(this.tooltip, "toggled", (i, s) => {
                    if (!s) return;
                    ...
                    const a = [F(document, `keydown ${ct}`, this.hide, !1, l => l.type === ct && !this.$el.contains(l.target) || l.type === "keydown" && l.keyCode === O.ESC), $([document, ...Rt(this.$el)], "scroll", n, {
                        passive: !0
                    })];
    ...
    function _o(t) {
        b(document, "uikit:init", t), document.body && _t(document.body, Ao), new MutationObserver(e => e.forEach(Ml)).observe(document, {
            subtree: !0,
            childList: !0
    ...
    var Do = {
        ...
        events: [{
            ...
            async handler(t) {
                var e;
                t.type === "keydown" && t.keyCode !== O.SPACE || (t.preventDefault(), (e = this._off) == null || e.call(this), this._off = Fl(t.target), await this.toggle($t(this.toggles, t.current)), this._off())
            }
        }, {
            name: "shown hidden",
            self: !0,
    ...
    async function zl(t, e, {
        ...
        var r;
        i = ((r = t._wrapper) == null ? void 0 : r.firstElementChild) || y(i, t), t._wrapper || (t._wrapper = di(i, "<div>"));
        const a = t._wrapper;
        h(a, "overflow", "hidden");
        ...
        const c = Nt(["marginTop", "marginBottom"], f => h(i, f)) + m(i).height,
            u = l / c;
        s = (n * c + s) * (e ? 1 - u : u), h(a, "height", l), await B.start(a, {
            height: e ? c : 0
        }, s, o), Be(i), delete t._wrapper, e || Bi(i, !0)
    }
    ...
    var Mo = {
        ...
        beforeConnect() {
            this.autoplay === "inview" && !It(this.$el, "preload") && (this.$el.preload = "none"), H(this.$el, "iframe") && !It(this.$el, "allow") && (this.$el.allow = "autoplay"), this.autoplay === "hover" && (H(this.$el, "video") ? this.$el.tabindex = 0 : this.autoplay = !0), this.automute && hn(this.$el)
        },
        events: [{
            name: `${Ht} focusin`,
            filter: ({
    ...
    var No = {
        ...
        computed: {
            ...
            target({
                ...
                return e || (e = t || this.targetEl), i || (i = t || this.targetEl), [e === !0 ? window : Z(e, s), i === !0 ? window : Z(i, s)]
            }
        },
        created() {
            this.tracker = new rn
        ...
        connected() {
            S(this.$el, "bdt-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = ql(this)), this._style = Ri(this.$el.style, ["width", "height"])
        },
        disconnected() {
        ...
        methods: {
            show(t = this.targetEl, e = !0) {
                if (this.isToggled() && t && this.targetEl && t !== this.targetEl && this.hide(!1, !1), this.targetEl = t, this.clearTimers(), !this.isActive()) {
                    ...
                    this.container && D(this.$el) !== this.container && q(this.container, this.$el), this.showTimer = setTimeout(() => this.toggleElement(this.$el, !0), e && this.delayShow || 0)
                }
            },
            hide(t = !0, e = !0) {
            ...
            isDelaying() {
                return [this.$el, ...z(".bdt-drop", this.$el)].some(t => this.tracker.movesTo(t))
            },
            position() {
                const t = Co(this.$el);
                _(this.$el, "bdt-drop-stack"), h(this.$el, this._style), this.$el.hidden = !0;
                ...
                this.$el.hidden = !1, h(this.$el, "maxWidth", ""), this.$el.offsetWidth > n && S(this.$el, "bdt-drop-stack"), h(this.$el, "maxWidth", n), this.positionAt(this.$el, this.target, this.boundary);
    ...
    function ql(t) {
        const {
            $el: e
        } = t.$create("toggle", Z(t.toggle, t.$el), {
            target: t.$el,
            mode: t.mode
        });
    ...
    function Gl(t) {
        return $(document, ct, ({
            ...
            t.$el.contains(e) || F(document, `${Et} ${oi} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
    ...
    var Fo = {
        ...
        computed: {
            ...
            dropbar({
                ...
                return t ? (t = this._dropbar || Z(t, this.$el) || y(`+ .${this.clsDropbar}`, this.$el), t || (this._dropbar = y("<div></div>"))) : null
            },
            dropContainer(t, e) {
        ...
        events: [{
            ...
            handler(t) {
                ...
                s === O.DOWN && (n == null ? void 0 : n.targetEl) === i && (t.preventDefault(), (e = y(_e, n.$el)) == null || e.focus()), Ho(t, this.items, n)
            }
        }, {
            name: "keydown",
            el: ({
            ...
            handler(t) {
                ...
                let r = -1;
                if (s === O.HOME ? r = 0 : s === O.END ? r = "last" : s === O.UP ? r = "previous" : s === O.DOWN ? r = "next" : s === O.ESC && ((e = o.targetEl) == null || e.focus()), ~r) {
                    t.preventDefault();
                    const a = z(_e, i);
            ...
            handler({
                ...
                this.isDropbarDrop(t) && (this.dropbar.previousElementSibling !== this.dropbarAnchor && ui(this.dropbarAnchor, this.dropbar), S(t, `${this.clsDrop}-dropbar`))
            }
        }, {
            name: "show",
            el: ({
            ...
            handler({
                ...
                const e = this.getDropdown(t),
                    i = () => {
                        const s = Math.max(...Oe(t, `.${this.clsDrop}`).concat(t).map(n => E(n).bottom));
                        E(this.dropbar, {
        ...
        methods: {
            ...
            async transitionTo(t, e) {
                ...
                h(e, "clipPath", `polygon(0 0,100% 0,100% ${s}px,0 ${s}px)`), et(i, s), await Promise.all([B.start(i, {
                    height: t
    ...
    function Ho(t, e, i) {
        ...
        let l = -1;
        a === O.HOME ? l = 0 : a === O.END ? l = "last" : a === O.LEFT ? l = "previous" : a === O.RIGHT ? l = "next" : a === O.TAB && ((s = i.targetEl) == null || s.focus(), (n = i.hide) == null || n.call(i, !1)), ~l && (t.preventDefault(), (o = i.hide) == null || o.call(i, !1), e[nt(l, e, e.indexOf(i.targetEl || r))].focus())
    }
    var Xl = {
            mixins: [it],
            args: "target",
        ...
        Jl = {
            ...
            update: [{
                ...
                read(t) {
                    ...
                    if (s = Math.max(0, Y(s)), !(i || s || n) || Lo(e) || e[0].some((w, I) => e.some(P => P[I] && P[I].offsetWidth !== w.offsetWidth))) return t.translates = t.scrollColumns = !1;
                    let r = Ql(e, o),
                        a, l;
                    ...
                    const c = a.map(w => Nt(w, "offsetHeight") + r * (w.length - 1)),
                        u = Math.max(0, ...c);
                    let f, d, p;
                    return (s || n) && (f = c.map((w, I) => n ? u - w + s : s / (I % 2 || 8)), n || (s = Math.max(...c.map((w, I) => w + f[I] - u))), d = Y(this.parallaxStart, "height", this.$el, !0), p = Y(this.parallaxEnd, "height", this.$el, !0)), {
                        columns: a,
                        translates: l,
                        scrollColumns: f,
                        parallaxStart: d,
        ...
        for (let a of t) {
            ...
            for (const c in a) {
                const {
                    offsetWidth: u,
                    offsetHeight: f
                } = a[c], d = i ? c : o.indexOf(Math.min(...o));
    ...
    var th = {
        ...
        update: {
            read() {
                return {
                    rows: (this.row ? bs(this.elements) : [this.elements]).map(eh)
                }
            },
            write({
                rows: t
    ...
    var sh = {
            ...
            update: {
                read() {
                    ...
                    if (t = `calc(${r?"100vh":`${o}px`}`, this.expand) {
                        ...
                        this.offsetBottom === !0 ? t += ` - ${m(this.$el.nextElementSibling).height}px` : mt(this.offsetBottom) ? t += ` - ${this.offsetBottom}vh` : this.offsetBottom && Qt(this.offsetBottom, "px") ? t += ` - ${k(this.offsetBottom)}px` : N(this.offsetBottom) && (t += ` - ${m(Z(this.offsetBottom,this.$el)).height}px`)
                    }
                    return t += `${e?` - ${e}px`:""})`, {
                        minHeight: t
                    }
        ...
        oh = '<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',
        rh = '<svg width="20" height="20" viewBox="0 0 20 20"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',
        ah = '<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',
        lh = '<svg width="20" height="20" viewBox="0 0 20 20"><rect width="1" height="11" x="9" y="4"/><rect width="11" height="1" x="4" y="9"/></svg>',
        hh = '<svg width="14" height="14" viewBox="0 0 14 14"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 4 7 10 13 4"/></svg>',
        ...
        fh = '<svg width="20" height="20" viewBox="0 0 20 20"><style>.bdt-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.bdt-navbar-toggle-icon svg&gt;.line-3{opacity:0}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{opacity:1}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-2{transform:rotate(45deg)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{transform:rotate(-45deg)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1,.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{opacity:0}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1{transform:translateY(6px) scaleX(0)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect width="20" height="2" y="3" class="line-1"/><rect width="20" height="2" y="9" class="line-2"/><rect width="20" height="2" y="9" class="line-3"/><rect width="20" height="2" y="15" class="line-4"/></svg>',
        dh = '<svg width="40" height="40" viewBox="0 0 40 40"><rect width="1" height="40" x="19" y="0"/><rect width="40" height="1" x="0" y="19"/></svg>',
        ph = '<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',
        gh = '<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',
        ...
        mh = '<svg width="40" height="40" viewBox="0 0 40 40"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',
        vh = '<svg width="24" height="24" viewBox="0 0 24 24"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',
        bh = '<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5"/></svg>',
        wh = '<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1"/></svg>',
        xh = '<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547"/></svg>',
        $h = '<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23"/></svg>',
        yh = '<svg width="30" height="30" viewBox="0 0 30 30"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>',
        kh = '<svg width="18" height="10" viewBox="0 0 18 10"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9"/></svg>',
        jo = {
            args: "src",
            props: {
                width: Number,
            ...
            connected() {
                this.svg = this.getSvg().then(t => {
                    ...
                    return this.svgEl && e !== this.svgEl && ot(this.svgEl), Ih.call(this, e, t), this.svgEl = e
                }, A)
            },
            disconnected() {
                this.svg.then(t => {
    ...
    var Eh = {
        ...
        async connected() {
            ...
            const t = await this.svg;
            t && (qo.call(this, t), this.strokeAnimation && _h(t))
        },
        methods: {
            async getSvg() {
                return H(this.$el, "img") && !this.$el.complete && this.$el.loading === "lazy" && await new Promise(t => F(this.$el, "load", t)), Ch(await Th(this.src), this.icon) || Promise.reject("SVG not found.")
            }
        }
    };
    ...
    const Th = ht(async t => t ? gt(t, "data:") ? decodeURIComponent(t.split(",")[1]) : (await fetch(t)).text() : Promise.reject());

    function Ch(t, e) {
        return e && v(t, "<symbol") && (t = Ph(t)[e] || t), Vo(t)
    }
    ...
    const Ni = {
        ...
        Oh = {
            ...
            beforeConnect() {
                ...
                if (this.icon = t ? "search-toggle-icon" : x(this.$el, "bdt-search-icon") && this.$el.closest(".bdt-search-large") ? "search-large" : this.$el.closest(".bdt-search-medium") ? "search-medium" : this.$props.icon, !It(this.$el, "aria-label"))
                    if (t) {
    ...
    function Lh(t) {
        t.icon.add = (e, i) => {
            ...
            se(s, (n, o) => {
                Ni[o] = n, delete zi[o]
            }), t._initialized && _t(document.body, n => se(t.getComponents(n), o => {
    ...
    function jh(t) {
        return t = Wh[t] || t, Ni[t] ? (zi[t] || (zi[t] = Vo(Ni[Rh(t)] || Ni[t])), zi[t].cloneNode(!0)) : null
    }
    ...
    var qh = {
        ...
        methods: {
            load() {
                ...
                const t = Ms(this.$el) ? this.$el : Vh(this.$el, this.dataSrc, this.sources);
    ...
    function Ds(t, e) {
        ...
        } else e && !v(t.style.backgroundImage, e) && (h(t, "backgroundImage", `url(${Ji(e)})`), b(t, he("load", !1)))
    }
    const Uh = ["data-src", "data-srcset", "sizes"];
            ...
            observe: (t, e) => {
                const i = Fe([...T(t), document.documentElement], e),
                    s = [$(document, "scroll itemshown itemhidden", e, {
                        passive: !0,
                        capture: !0
                    }), $(document, "show hide transitionstart", n => (e(), i.observe(n.target))), $(document, "shown hidden transitionend transitioncancel", n => (e(), i.unobserve(n.target)))];
                return {
        ...
        update: {
            read() {
                ...
                for (const t of T(this.target)) {
                    let e = !this.selActive || C(t, this.selActive) ? Jh(t) : "";
    ...
    function Jh(t) {
        ...
        for (const l of [.25, .5, .75]) {
            ...
            for (const u of c) {
                if (t.contains(u) || !Kh(u) || u.closest('[class*="-leave"]') && c.some(d => u !== d && C(d, '[class*="-enter"]'))) continue;
    ...
    var Qh = {
            ...
            computed: {
                fill: ({
                    fill: t
                }, e) => t || h(e, "--bdt-leader-fill-content")
            },
            connected() {
        ...
        Zh = {
            ...
            events: [{
                ...
                self: !0,
                handler() {
                    x(this.panel, "bdt-margin-auto-vertical") ? S(this.$el, "bdt-flex") : h(this.$el, "display", "block"), et(this.$el)
                }
            }, {
                name: "hidden",
                self: !0,
    ...
    function tc({
        ...
        t.dialog = function(i, s) {
            ...
            return e(({
                i18n: n
            }) => `<div class="bdt-modal-body">${N(i)?i:Pt(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-primary bdt-modal-close" autofocus>${n.ok}</button> </div>`, s)
        }, t.confirm = function(i, s) {
            return e(({
                i18n: n
            }) => `<form> <div class="bdt-modal-body">${N(i)?i:Pt(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${n.cancel}</button> <button class="bdt-button bdt-button-primary" autofocus>${n.ok}</button> </div> </form>`, s, () => Promise.reject())
        }, t.prompt = function(i, s, n) {
            const o = e(({
                    i18n: l
                }) => `<form class="bdt-form-stacked"> <div class="bdt-modal-body"> <label>${N(i)?i:Pt(i)}</label> <input class="bdt-input" autofocus> </div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${l.cancel}</button> <button class="bdt-button bdt-button-primary">${l.ok}</button> </div> </form>`, n, () => null, () => a.value),
                {
                    $el: r
                } = o.dialog,
                a = y("input", r);
    ...
    var ic = {
        ...
        events: [{
            ...
            handler({
                ...
                this.getTransparentMode(t) === "remove" && x(this.navbarContainer, Bs) && (_(this.navbarContainer, Bs), this._transparent = !0)
            }
        }, {
            name: "hide",
            el: ({
            ...
            async handler() {
                await sc(), !this.getActive() && this._transparent && (S(this.navbarContainer, Bs), this._transparent = null)
            }
        }],
        methods: {
    ...
    var nc = {
        ...
        events: [{
            ...
            self: !0,
            handler() {
                this.mode === "reveal" && !x(D(this.panel), this.clsMode) && (di(this.panel, "<div>"), S(D(this.panel), this.clsMode));
                const {
                    body: t,
                    scrollingElement: e
                } = document;
                S(t, this.clsContainer, this.clsFlip), h(t, "touch-action", "pan-y pinch-zoom"), h(this.$el, "display", "block"), h(this.panel, "maxWidth", e.clientWidth), S(this.$el, this.clsOverlay), S(this.panel, this.clsSidebarAnimation, this.mode === "reveal" ? "" : this.clsMode), et(t), S(t, this.clsContainerAnimation), this.clsContainerAnimation && oc()
            }
        }, {
            name: "hide",
            self: !0,
            ...
            self: !0,
            handler() {
                this.clsContainerAnimation && rc(), this.mode === "reveal" && Be(this.panel), _(this.panel, this.clsSidebarAnimation, this.clsMode), _(this.$el, this.clsOverlay), h(this.$el, "display", ""), h(this.panel, "maxWidth", ""), _(document.body, this.clsContainer, this.clsFlip)
            }
        }, {
    ...
    var ac = {
        ...
        lc = {
            props: ["width", "height"],
            connected() {
                S(this.$el, "bdt-responsive-width"), h(this.$el, "aspectRatio", `${this.width}/${this.height}`)
            }
        },
        hc = {
            props: {
            ...
            methods: {
                async scrollTo(t) {
                    t = t && y(t) || document.body, b(this.$el, "beforescroll", [this, t]) && (await pn(t, {
                        offset: this.offset
    ...
    function cc(t) {
        Qe.size || $(document, "click", Jo), Qe.add(t)
    }

    function uc(t) {
        Qe.delete(t), Qe.size || Tt(document, "click", Jo)
    }

    function Jo(t) {
        if (!t.defaultPrevented)
            for (const e of Qe) e.$el.contains(t.target) && ae(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(Yi(e.$el)))
    }
    ...
    var fc = {
            ...
            watch: {
                elements(t) {
                    this.hidden && h(Ae(t, `:not(.${Ns})`), "opacity", 0)
                }
            },
            connected() {
        ...
        pc = {
            ...
            connected() {
                this.start = Ko(this.start || this.top), this.end = Ko(this.end || this.bottom), this.placeholder = y("+ .bdt-sticky-placeholder", this.$el) || y('<div class="bdt-sticky-placeholder"></div>'), this.isFixed = !1, this.setActive(!1)
            },
            beforeDisconnect() {
                this.isFixed && (this.hide(), _(this.target, this.clsInactive)), Qo(this.$el), ot(this.placeholder), this.placeholder = null
            },
            observe: [vs(), We({
            ...
            update: [{
                read({
                    ...
                    o && (Hs(this.target), this.hide()), this.active || ({
                        height: t,
                        width: e
                    } = m(this.$el), i = h(this.$el, "margin")), o && this.show();
                ...
                write({
                    ...
                    h(o, {
                        ...
                        width: e,
                        margin: i
                    }), (D(o) !== D(this.$el) || n ^ $t(o) < $t(this.$el)) && ((n ? ci : ui)(this.$el, o), o.hidden = !0)
                },
                events: ["resize"]
            }, {
                read({
                ...
                write(t, e) {
                    ...
                    if ((f - s > 300 || n !== o) && (t.initScroll = r, t.initTimestamp = f), !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - r) <= 30 && Math.abs(a - r) <= 10))
                        ...
                        } else this.isFixed ? this.update() : this.animation && u ? (this.show(), Ct.in(this.$el, this.animation).catch(A)) : (Hs(this.target), this.show())
                },
            ...
            methods: {
                ...
                hide() {
                    ...
                    this.setActive(!1), _(this.$el, this.clsFixed, this.clsBelow), e ? h(this.$el, "top", t) : h(this.$el, {
                        position: "",
                        top: "",
                        width: "",
                        marginTop: ""
                ...
                update() {
                    ...
                    if (!l) {
                        let f = "fixed";
                        e > o && (r += o - a + s - i, f = "absolute"), h(this.$el, {
                            position: f,
                            width: t,
                            marginTop: 0
                        }, "important")
                ...
                setActive(t) {
                    const e = this.active;
                    this.active = t, t ? (si(this.target, this.clsInactive, this.clsActive), e !== t && b(this.$el, "active")) : (si(this.target, this.clsActive, this.clsInactive), e !== t && (Hs(this.target), b(this.$el, "inactive")))
                }
            }
        };
    ...
    var Zo = {
            ...
            events: [{
                ...
                handler(t) {
                    !C(t.current, Ls) && (t.type === "click" || t.keyCode === O.SPACE) && (t.preventDefault(), this.show(t.current))
                }
            }, {
                name: "keydown",
                delegate: ({
            ...
            update() {
                ...
                for (const e in this.toggles) {
                    ...
                    g(i, "role", "tab"), s && (i.id = Yt(this, i), s.id = Yt(this, s), g(i, "aria-controls", s.id), g(s, {
                        role: "tabpanel",
                        "aria-labelledby": i.id
                    }))
                }
            ...
            methods: {
                ...
                show(t) {
                    ...
                    this.children.forEach((r, a) => {
                        j(r, this.cls, n === a), g(this.toggles[a], {
                            "aria-selected": n === a,
                            tabindex: n === a ? null : -1
                        })
                    });
    ...
    var vc = {
            ...
            computed: {
                target: {
                    get: ({
                        target: t
                    }, e) => (t = De(t || e.hash, e), t.length ? t : [e]),
                    observe: ({
                        target: t
                    }) => t
                }
            ...
            connected() {
                v(this.mode, "media") || (ai(this.$el) || g(this.$el, "tabindex", "0"), !this.cls && H(this.$el, "a") && g(this.$el, "role", "button"))
            },
            observe: Si({
                targets: ({
                    target: t
            ...
            events: [{
                ...
                handler(t) {
                    this._preventClick = null, !(!dt(t) || ie(this._showState) || this.$el.disabled) && (b(this.$el, "focus"), F(document, ct, () => b(this.$el, "blur"), !0, e => !this.$el.contains(e.target)), v(this.mode, "click") && (this._preventClick = !0))
                }
            }, {
                ...
                handler(t) {
                    t.keyCode === mc && (t.preventDefault(), this.$el.click())
                }
            }, {
                name: "click",
                filter: ({
                ...
                handler(t) {
                    let e;
                    (this._preventClick || t.target.closest('a[href="#"], a[href=""]') || (e = t.target.closest("a[href]")) && (!this.isToggled(this.target) || e.hash && C(this.target, e.hash))) && t.preventDefault(), !this._preventClick && v(this.mode, "click") && this.toggle()
                }
            }, {
                name: "mediachange",
                filter: ({
            ...
            methods: {
                async toggle(t) {
                    ...
                    if (It(this.$el, "aria-expanded") && g(this.$el, "aria-expanded", !this.isToggled(this.target)), !this.queued) return this.toggleElement(this.target);
    ...
    return se(bc, (t, e) => lt.component(e, t)), Dl(lt), se(Ol, (t, e) => lt.component(e, t)), lt
});