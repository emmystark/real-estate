        ...
        var o = function(e, t) {
            ...
            l = function(e, t) {
                ...
                t(n).on("click", (function(e) {
                    t(this).find("input.eae-content-toggle-switch").is(":checked") ? (o.addClass("active"), d.addClass("active"), i.removeClass("active"), l.removeClass("active")) : (i.addClass("active"), l.addClass("active"), o.removeClass("active"), d.removeClass("active")), window.dispatchEvent(new Event("resize"))
                }))
            };
                ...
                if ("slide" == t.coupon_type && "" != t.dynamic_coupon) {
                    ...
                    if ("yes" == t.preview_modal && elementorFrontend.isEditMode()) s.style.display = "none";
                        ...
                        S.addEventListener("touchstart", (e => {
                            const t = e.touches[0];
                            T = t.clientX - S.getBoundingClientRect().left, S.style.cursor = "grabbing"
                ...
                if ("scratch" === t.coupon_type && "" != t.dynamic_coupon)
                    if ("yes" == t.preview_modal && elementorFrontend.isEditMode()) a.querySelector("#eae-scratch-canvas").style.display = "none";
                        ...
                        function _(e) {
                            if (f) {
                                e.preventDefault();
                                for (var t, n, i, r, o, s = y(e, canvas), l = (i = u, r = s, Math.sqrt(Math.pow(r.x - i.x, 2) + Math.pow(r.y - i.y, 2))), d = function(e, t) {
                                        return Math.atan2(t.x - e.x, t.y - e.y)
                                    }(u, s), c = 0; c < l; c++) t = u.x + Math.sin(d) * c - 25, n = u.y + Math.cos(d) * c - 25, h.globalCompositeOperation = "destination-out", h.drawImage(w, t, n);
                                u = s, o = function(e) {
                                    (!e || e < 1) && (e = 1);
