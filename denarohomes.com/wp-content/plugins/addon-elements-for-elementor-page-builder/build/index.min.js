(() => {
                    ...
                    const t = function(e) {
                        ...
                        function f(e, t = "null") {
                            let i = e.getAttribute("data-video-type"),
                                a = e.querySelector(".eae-device-video-play"),
                                o = "",
                                r = "";
                            if (n.querySelector(".device-text").style.visibility = "hidden", "hosted" != i && (o = a.getAttribute("data-src")), "hosted" == i && (r = e.getAttribute("data-hosted-html")), "hosted" != i) {
                                var s = document.createElement("iframe");
                                s.classList.add("eae-video-iframe"), s.setAttribute("src", o), s.setAttribute("frameborder", "0"), s.setAttribute("allowfullscreen", "1"), s.setAttribute("allow", "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"), a.innerHTML = "", e.classList.contains(".eae-sticky-apply") || null == e.querySelector(".eae-video-display-details") || (e.querySelector(".eae-video-display-details").style.display = "none"), a.append(s)
                            } else if ("hosted" == i && null == a.querySelector(".eae-hosted-video")) {
                                a.innerHTML = "";
                                let e = JSON.parse(r);
                                a.innerHTML += e, a.querySelector("video").setAttribute("autoplay", "autoplay"), a.querySelector("video").style.width = "100%", a.querySelector("video").style.height = "100%"
                            }
                        }
                    };
                    e(window).on("elementor/frontend/init", (function() {
                    ...
                    const i = function(e) {
                        ...
                        if (n = r.getBoundingClientRect().top + window.scrollY, null != r) {
                            let e = r.getAttribute("data-video-type"),
                                ...
                                n = "",
                                l = "";
                            r.hasAttribute("data-video-sticky") && (t = r.getAttribute("data-video-sticky")), r.hasAttribute("data-autoplay") && (n = r.getAttribute("data-autoplay")), r.hasAttribute("data-lightbox") && (l = r.getAttribute("data-lightbox"));
                            var s = i.querySelector(".eae-lottie-animation");
                            if ("yes" == t) {
                                let e = r.getAttribute("data-preview-sticky");
                                if (elementorFrontend.isEditMode() && "yes" == e || !elementorFrontend.isEditMode()) {
                                    a(r), document.addEventListener("scroll", (() => {
                            ...
                            if ("yes" != l && r.addEventListener("click", (function(e) {
    ...
    }, n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), n(305), n(734), n(211), n(327), n(259), n(340), n(107), n(45), n(234), n(289), n(482), n(867), n(839), n(404), n(361), n(537), n(210), n(898), n(862), n(994), n(784), n(793), n(393), n(322), n(82), n(870)
})();